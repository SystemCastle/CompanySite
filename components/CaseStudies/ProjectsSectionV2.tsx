            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {featuredProject && (
                    ...
                    >
                        <div className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl overflow-hidden shadow-2xl">
                            ...
                            <div className="relative p-8 lg:p-16 flex flex-col lg:flex-row items-center gap-8">
                                <div className="flex-1 text-white">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 bg-white text-slate-900 px-6 py-3 rounded-full font-medium hover:shadow-lg transition-all hover:scale-105"
                                    >
                ...
                >
                    <div className="inline-flex items-center gap-6 bg-white border border-slate-200/60 rounded-full px-6 py-2.5 shadow-sm hover:shadow-md transition-shadow">
                        <span className="text-sm text-slate-600">Want to see more?</span>
                        <a
                            href="#"
