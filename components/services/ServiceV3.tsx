        ...
        >
            ...
            >
                ...
                <div style={{ transform: "translateZ(30px)" }} className="relative z-10 flex-1 flex flex-col">
                    ...
                    {/* Learn More with animated underline */}
                    <motion.a
                        href="#"
                        whileHover={{ x: 4 }}
                        className="inline-flex items-center gap-1.5 text-sm font-medium text-indigo-600 hover:text-indigo-700 transition-colors mt-3 group/link relative"
                    >
                        <span>Learn More</span>
                        <ChevronRight className="w-4 h-4 transition-transform group-hover/link:translate-x-1" />
                        <motion.span
                            className="absolute -bottom-0.5 left-0 right-0 h-0.5 bg-indigo-600"
                            initial={{ scaleX: 0 }}
                            whileHover={{ scaleX: 1 }}
                ...
                >
                    <div className="inline-flex items-center gap-6 bg-white border border-slate-200/60 rounded-full px-6 py-2.5 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <motion.a
                            ...
                            whileTap={{ scale: 0.97 }}
                            className="inline-flex items-center gap-2 bg-slate-900 text-white px-6 py-2 rounded-full text-sm font-medium hover:bg-slate-800 transition-all hover:shadow-lg"
                        >
